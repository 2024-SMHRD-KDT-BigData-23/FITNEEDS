			...
			<ul class="nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="pages/charts/chartjs.html"> <i
						class="mdi mdi-chart-bar menu-icon"></i> <span class="menu-title">나의운동비교</span>
				</a></li>

				<li class="nav-item"><a class="nav-link" href="myhealth.html">
						<i class="mdi mdi-check-circle menu-icon"></i> <span
						class="menu-title">나의운동입력</span>
				</a></li>

				<li class="nav-item"><a class="nav-link" href="ex_rsv.html">
					...
					<ul class="navbar-nav navbar-nav-right">
						...
						<li class="nav-item nav-profile dropdown d-none d-md-block">
							...
							<div class="dropdown-menu center navbar-dropdown"
								...
								<a class="dropdown-item" href="#"> <i
									class="mdi mdi-check-circle me-3"></i> 나의운동정보
								</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="#"> <i
